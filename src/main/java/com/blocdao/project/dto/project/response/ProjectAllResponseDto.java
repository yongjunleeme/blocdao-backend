...
public class ProjectAllResponseDto {
    ...
    public ProjectAllResponseDto(Project project, TempStacksService tempStacksService){
        ...
        this.createTime = project.getCreateTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
